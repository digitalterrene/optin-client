...
export default function Cookies() {
  const [dismissModal, setDismissModal] = useState(false); //comment here
      ...
      {!dismissModal && (
        <div className="fixed inset-0 z-[60] sm:max-w-4xl w-full mx-auto p-6">
          ...
          <div className="bg-white rounded-xl shadow-2xl dark:bg-slate-900 dark:shadow-black/[.7]">
            {/* <!-- Header --> */}
            <div className="p-4 rounded-lg md:px-6 bg-[#0F172A] ">
            ...
            <div className="p-4 md:p-6 h-[70vh] sm:h-[65vh] bg-gray-50 border-y border-gray-200 flex flex-col overflow-x-hidden overflow-y-auto dark:bg-slate-800 dark:border-gray-700">
              ...
              <div className="mt-4 space-y-5">
                ...
                <div className="flex gap-x-4">
                  <svg
                    className="flex-shrink-0 mt-1 w-4 h-4 text-gray-600 dark:text-gray-400"
              ...
              <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
                Non-personalised content is influenced by things like the
                content that you’re currently viewing, activity in your active
                Search session, and your location. Non-personalised ads are
                influenced by the content that you’re currently viewing and your
                general location.
              </p>
            </div>
            {/* <!-- End Body --> */}
