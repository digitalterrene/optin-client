    ...
    <div className="  ">
      <div className="overflow-x-hidden bg-gray-50">
        <div className="relative   xl:pb-0">
          <div className="relative mx-auto hidden max-w-screen-lg md:block"></div>
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              <h1 className="mt-5 text-3xl font-light leading-snug text-gray-900 sm:text-5xl sm:leading-snug lg:text-6xl lg:leading-snug">
                Always ready to answer <br className="sm:hidden" />
              ...
              <p className="mx-auto mt-10 max-w-md text-base leading-7 text-gray-600"></p>
            </div>
          </div>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-xl mx-auto">
          <div className="text-center z-[999]">
            <h1 className="text-3xl font-bold z-[999] text-gray-800 sm:text-4xl dark:text-white">
              Contact us
            </h1>
