...
import african_map from "@/assets/data/africa_map.png";
import features from "@/assets/data/features.png";
export default function HomePage() {
  return (
    <div className="bgx-red-900">
              ...
              <div className="lg:col-span-4">
                <div className="lg:pe-6 xl:pe-12">
                  ...
                  <p className="mt-2 sm:mt-3 text-gray-500">
                    of African adults have bought have signed up on this
                    Platform
                  </p>
                </div>
              </div>
                ...
                <div className="grid gap-6 grid-cols-2 md:grid-cols-4 lg:grid-cols-3 sm:gap-8">
                  <div>
                    ...
                    <p className="mt-1 text-gray-500">
                      in intuitive platform design
                    </p>
                  </div>
                  <div>
                    <p className="text-3xl font-semibold text-blue-600">17+</p>
                    <p className="mt-1 text-gray-500">partner with Optin</p>
                  </div>
                  <div>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <h2 className="text-3xl w-fit mx-auto pb-24 text-gray-800 font-bold lg:text-4xl dark:text-white">
          Benefits and Features
        </h2>
        <div className="grid sm:grid-cols-2   lg:grid-cols-3 items-center gap-6 md:gap-10">
          <div className="w-full h-full bg-white border cursor-pointer hover:border-blue-300 shadow-lg rounded-lg p-5 dark:bg-slate-900">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Access a network of seasoned consultants covering various
              industries.
            </p>
          </div>
          <div className="w-full h-full bg-white shadow-lg  border cursor-pointer hover:border-blue-300 rounded-lg p-5 dark:bg-slate-900">
            <div className="flex items-center gap-x-4 mb-3">
              <div className="inline-flex justify-center items-center w-[62px] h-[62px] rounded-full border-4 border-blue-50 bg-blue-100 dark:border-blue-900 dark:bg-blue-800">
                <svg
                  className="flex-shrink-0 w-6 h-6 text-blue-600 dark:text-blue-400"
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Leverage cutting-edge strategies and insights to stay ahead in a
              competitive landscape.
            </p>
          </div>
          <div className="w-full h-full border cursor-pointer hover:border-blue-300 bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
            <div className="flex items-center gap-x-4 mb-3">
              <div className="inline-flex justify-center items-center w-[62px] h-[62px] rounded-full border-4 border-blue-50 bg-blue-100 dark:border-blue-900 dark:bg-blue-800">
                <svg
                  className="flex-shrink-0 w-6 h-6 text-blue-600 dark:text-blue-400"
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Receive one-on-one support, ensuring solutions align with your
              business goals.
            </p>
          </div>
          <div className="w-full h-full border cursor-pointer hover:border-blue-300 bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Join a community of businesses that have elevated their strategies
              with Optin Consult.
            </p>
          </div>
        </div>
      </div>
      <div className="ml-auto w-fit bg-repeat flex items-center -mt-32 px-24">
        <img className=" " src={features.src} />
      </div>
      <div className="max-w-[85rem] my-20 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
